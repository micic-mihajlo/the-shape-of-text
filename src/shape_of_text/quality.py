...
FOUNDER_REWRITE_GLOBAL_AVOID_TERMS = (
    ...
    "small change, but it matters",
    "small change but it matters",
    "users notice the difference",
    "minor change, but it matters",
    "shipping for the user experience is the goal",
    "creator economy loses its spark",
    "loses its spark",
    "soul of the content",
    "building for the soul",
    "optimized and dead",
    "optimized and lifeless",
    "data was lying to us",
    ...
    "didn't land well",
    "not everything",
    "clearer information changed the outcome",
    "the change was simple",
)

FOUNDER_REWRITE_SLOP_PATTERNS = (
    *(rf"\b{re.escape(term)}\b" for term in FOUNDER_REWRITE_GLOBAL_AVOID_TERMS),
    ...
    r"\bbetter support is about\b",
    r"\bthe difference between a ([a-z]+) and a \1\b",
    r"\bnot just\b[^.!?]{0,120}\bit (?:is|'s)\b",
)
